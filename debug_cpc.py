...
from scipy.ndimag.morphology import grey_dilation
...
thanard_dset = False
encoder = torch.load(join(name, 'encoder.pt'), map_location='cuda')
trans = torch.load(join(name, 'trans.pt'), map_location='cuda')
